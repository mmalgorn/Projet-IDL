...
public class file_listImpl extends file_listPOA {
	...
	/*
	 * Affecte l'entrée du répertoire au holder Renvoie vrai si il reste des
	 * entrées dans liste ou faux sinon
	 */
	public boolean next_one(directory_entryHolder e) {
		...
		if (f.isFile())
			e.value.type = file_type.regular_file_type;
		else
			e.value.type = file_type.directory_type;
