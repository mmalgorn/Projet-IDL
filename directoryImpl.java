...
public class directoryImpl extends directoryPOA {
	...
	/*
	 * Affecte au holder le fichier régulier correspondant au nom passé en argument et ouvert dans le mode d'écriture
	 * spécifié
	...
	/*
	 * Crée un nouveau fichier physiquement ainsi qu'une nouvelle instance de fichier régulier et l'affecte au holder
	...
	/*
	 * Crée un nouveau répertoire physiquement ainsi qu'une une nouvelle instance de répertoire et l'affecte au holder
	 * Renvoie une exception Already_exist si un fichier ou repertoire du même nom existe déjà
	 */
	...
	/*
	 * Supprime le fichier ou le répertoire correspondant au nom passé en argument si le fichier est non-vide ses
	 * fichiers et sous-répertoires sont supprimés
